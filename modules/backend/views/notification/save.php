...
<h2 style="margin:0px 0px 20px;"><?php if ($setting->isNewRecord): ?>Добавить событие<?php else: ?>Редактировать событие<?php endif; ?></h2>
...
echo '<div class="row">';
    ...
    echo '<div class="col-md-5">';
        ...
        echo $form->field($setting, 'model');

        echo $form->field($setting, 'event');
